...
**Preserve Data**
>In this section of project we have to use ruby json to preserve the data from app and load preserved data on startup.

**Unit Test**
>In this section of project we have added unit tests to our codebase, specifically to our classes.
...
This project is [MIT](https://github.com/Osoro254Alex/OOP-school-library/blob/dev/LICENSE) licensed.
